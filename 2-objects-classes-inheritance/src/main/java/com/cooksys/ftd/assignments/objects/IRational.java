...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int theNumerator = ( this.getNumerator() * that.getDenominator() ) + ( that.getNumerator() * this.getDenominator() );
		int theDenominator = ( this.getDenominator() * that.getDenominator() );
		return construct(theNumerator, theDenominator);
	}
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		int theNumerator = (this.getNumerator() * that.getNumerator());
		int theDenominator = (this.getDenominator() * that.getDenominator());
		return construct(theNumerator, theDenominator);
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		...
		int theNumerator = this.getNumerator() * that.getDenominator();
		int theDenominator = this.getDenominator() * that.getNumerator();
		return construct(theNumerator, theDenominator);
	}
}
